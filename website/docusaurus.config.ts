...
const config: Config = {
  ...
  url: 'https://openmuara.github.io',
  baseUrl: '/openmuara/',

  organizationName: 'openmuara',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/openmuara/openmuara/tree/main/',
          routeBasePath: 'docs',
          exclude: ['initiatives/**', 'projects/**', 'cli-schemas/**'],
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/openmuara/openmuara',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'More',
          items: [
            {label: 'GitHub', href: 'https://github.com/openmuara/openmuara'},
          ],
        },
      ],
