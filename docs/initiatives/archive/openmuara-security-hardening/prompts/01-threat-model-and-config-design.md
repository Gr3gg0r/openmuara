...
4. Lock down `muara security` CLI command names and scope: `hash-password`, `gen-cert`, `audit`.
5. Lock down CI security scanning tools: `gosec` + `gitleaks` (or `trufflehog`), keep `govulncheck`.
6. Update `TRACKING.md` prompt 01 to `✅`.
7. Update `HANDOFF.md`.
