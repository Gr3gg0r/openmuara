...
# OpenMuara Billplz — Execution Tracker

> **Updated:** 2026-07-01 | **Status:** ✅ Completed
>
> **Scope:** Emulate Billplz v3 API for local Malaysian payment testing.
...
|------|-------|--------------|------------|--------|--------|-------|
| P01 | Billplz Provider | `internal/billplz/*`, `internal/provider`, `internal/webhook`, `internal/ui`, tests, smoke test | — | ✅ | e6d02f4 | Implemented collections, bills, local payment page, redirect, callback/webhook, and tests. |
...
- D001 ✅ Add Billplz as a first-class OpenMuara provider named `billplz`.
