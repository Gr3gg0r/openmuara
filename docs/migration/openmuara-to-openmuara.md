...
|---|---|---|---|
| pre-0.1 `muara` | 0.1.0 | Module path, binary name, config path renamed | Follow the upgrade steps below |
| 0.1.0 | 0.1.x | Minor releases are backward-compatible | Review CHANGELOG for new provider config options |
...
## Upgrading from pre-0.1 `muara` to OpenMuara 0.1.0
