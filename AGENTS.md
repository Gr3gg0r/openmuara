...
- Migration guide: `docs/migration/openmuara-to-openmuara.md`

---

## 13. When this document is incomplete

If a command, port, or env var here disagrees with a nested **README** or
more specific doc, follow that document and update this file to match.
